...
const std::string DoBase64EncodeBlock( const std::vector<smtp::byte> &data_block, const std::string &table, int padding = 0 );
...
const std::string DoBase64EncodeBlock(const std::vector<smtp::byte> &data_block, const std::string &table, int padding)
{
