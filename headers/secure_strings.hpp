...
// This allocator zeroes out the memory for the object that is allocated once the object 
// goes out of scope.
// This allocator is used to construct objects such as vectors or strings that may contain 
// passwords.
template<class T>
