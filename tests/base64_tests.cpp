...
TEST( Base64UrlDecodingTests, DecodePaddingTest )
{
	...
	CHECK_EQUAL( std::string("What does it take for a boar to soar in New York. Are you well today sir??? Well if you are then you please visit me in new york? See you soon"), actual );
}
