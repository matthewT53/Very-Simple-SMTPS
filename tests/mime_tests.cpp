...
TEST_GROUP( MimeTests )
{
	...
	void setup()
	{
		...
		m_binary << "\x90\x12\x87\x85\x43\x65\x10\x12\x65\x90\x34\x23\x25\x65\x41\x42\x43\xf9";
		...
		// Close the stream here otherwise, we can't read from these files with an input stream.
		m_text.close();
		m_binary.close();
		m_large.close();
	}
...
TEST( MimeTests, NoAttachmentsTest )
{
	...
	const std::string &expected = "User-Agent: test_user_agent\r\n"
								  ...
								  " boundary=\"" + smtp::Mime::kBoundaryDeclare + "\"" + "\r\n" +
...
TEST( MimeTests, VeryLargeAttachmentTest )
{
	...
	const std::string &expected =   "User-Agent: test_user_agent\r\n"
									...
									"5+jp6uvs7e7v8PHy8/T19vf4+fr7/P3+/wABAgMEBQYHCAkKCwwNDg8QERITFBUWFxgZGhscHR4fI"
									"CEiIyQlJicoKSorLC0uLzAxMjM0NTY3OD"
									"k6Ozw9Pj9AQUJDREVGR0hJSktMTU5PUFFSU1RVVldYWVpbXF1eX2BhYmNkZWZnaGlqa2xtbm9wcXJ"
									"zdHV2d3h5ent8fX5/\r\n"
									"gIGCg4SFhoeIiYqLjI2Oj5CRkpOUlZaXmJmam5ydnp+goaKjpKWmp6ipqqusra6vsLGys7S1tre4ub"
									"q7vL2+v8DBwsPExcbHyMnKy8zNzs/Q0dLT1NXW19jZ2tvc3d7f4OHi4+Tl5ufo6err7O3u7/Dx8vP0"
									"9fb3+Pn6+/z9/v8AAQIDBAUGBwgJCgsMDQ4PEBESExQVFhcYGRobHB0eHyAhIiMkJSYnKCkqKywtLi"
									"8wMTIzNDU2Nzg5Ojs8PT4/QEFCQ0RFRkdISUpLTE1OT1BRUlNUVVZXWFlaW1xdXl9gYWJjZGVmZ2hp"
									"amtsbW5vcHFyc3R1dnd4eXp7fH1+f4CBgoOEhYaHiImKi4yNjo+QkZKTlJWWl5iZmpucnZ6foKGio6"
									"SlpqeoqaqrrK2ur7CxsrO0tba3uLm6u7y9vr/AwcLDxMXGx8jJysvMzc7P0NHS09TV1tfY2drb3N3e"
									...
									"7PD0+P0BBQkNERUZHSElKS0xNTk9QUVJTVFVWV1hZWltcXV5fYGFiY2RlZmdoaWprbG1ub3BxcnN0dX"
									"Z3eHl6e3x9fn+AgYKDhIWGh4iJiouMjY6PkJGSk5SVlpeYmZqbnJ2en6ChoqOkpaanqKmqq6ytrq+ws"
									"bKztLW2t7i5uru8vb6/wMHCw8TFxsfIycrLzM3Oz9DR0tPU1dbX2Nna29zd3t/g4eLj5OXm5+jp6uvs"
									"7e7v8PHy8/T19vf4+fr7/P3+/wABAgMEBQYHCAkKCwwNDg8QERITFBUWFxgZGhscHR4fICEiIyQlJic"
									"oKSorLC0uLzAxMjM0NTY3ODk6"
									"Ozw9Pj9AQUJDREVGR0hJSktMTU5PUFFSU1RVVldYWVpbXF1eX2BhYmNkZWZnaGlqa2xtbm9wcXJzdHV"
									"2d3h5ent8fX5/\r\n"
