...
class MimeMock : public smtp::IMime
{
    ...
    protected:
        ...
        {
            std::string result;
            for (const auto &line : build()) result += line;
...
TEST( EmailTestGroup, BasicEmailTest )
{
    ...
    email.setBody("Hey mate, I have been working here for 5 years now, I think its time for a pay rise.");
